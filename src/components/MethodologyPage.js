  ...
  return (
    <div className="methodology-container">
      ...
      <div className="methodology-sections">
        {methodologies.map((method, index) => (
          <div className="methodology-block" key={index}>
            <img src={method.image} alt={`${method.title} Method`} className="methodology-image" />
            <h2>{method.title}</h2>
      ...
      <div className="summary-box">
        <p>Ces approches vous garantissent une collaboration efficace, flexible et orientée vers les résultats, pour des projets menés avec rigueur et sérénité.</p>
      </div>
    </div>
  );
};
